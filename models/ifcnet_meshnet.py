...
from .modules.meshnet import MeshNet
from .utils.plot_results import plot_confusion_matrix
import pathlib

def _meshnet_loss(pred, label):
    loss = F.cross_entropy(pred, label)
    return loss

class IFCNet_MeshNet(L.LightningModule):
    ...
    def on_test_epoch_end(self):
        ...
        plot_confusion_matrix(confusion_mat, self.classnames, fname=pathlib.Path("./report/MeshNet_confusion_matrix.png"))
